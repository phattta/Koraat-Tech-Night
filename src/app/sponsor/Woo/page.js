...
export default function page() {
    return (
        <div>
            <div className="flex flex-col items-center justify-centerp-6">
                {/* ชื่อ Sponsor */}
                ...
                <div className="max-w-3xl text-lg text-white space-y-6 leading-relaxed mb-25">
                    <p>
                        <a href="#" className="text-blue-500 hover:text-blue-600 underline">
                            Woo
                        </a> is the leading open-source ecommerce platform, powering 31.4% of the top million online stores.* Built on WordPress, Woo empowers anyone, anywhere, to sell anything with truly unlimited extensibility, flexibility, and control over how they build and evolve their business.
                    </p>
                    <p>
                        * StoreLeads,{" "}
                        <a href="#" className="text-blue-500 hover:text-blue-600 underline">
                            StoreLeads.app, January 2024
                        </a>,
                    </p>
                </div>
